...
def add_item_to_shopping_list(lists_by_name, list_name, item_name):
    ...
    if list_name in lists_by_name:
        ...
        if item_name not in shopping_list:
            ...
            item_list = item_name.strip().split(",")
            x = 0
            for i in item_list:
                shopping_list.append(item_list[x])
                x += 1
    ...
    while True:
        ...
        if choice == 0:
            ...
            if list_name in shopping_lists_by_name:
                ...
                item_name = raw_input('Enter your items separated by commas: ')
                add_item_to_shopping_list(shopping_lists_by_name, list_name, item_name)
